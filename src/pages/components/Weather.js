    ...
    <Box sx={{ p: 0 }}>
      ...
      {!data ? (
        ...
        <Box sx={{ height: "250px" }}>
          ...
          <Divider sx={{ my: 1 }} />
          <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", pb: 1 }}>
            <img src={"https://openweathermap.org/img/wn/" + data.weather[0].icon + "@2x.png"} style={{ width: "120px" }} />
