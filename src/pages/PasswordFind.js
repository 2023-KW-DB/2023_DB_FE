...
const PasswordFind = () => {
  ...
  const onSubmitAuthCode = async (e) => {
    ...
    (async() => {
      // Do login
      try {
        const response = await fetch(process.env.REACT_APP_API_URL + "/users/send-authcode", {
          method: "POST",
  ...
  const onSubmitPasswordChange = () => {
    ...
    (async() => {
      // Do login
      try {
        const response = await fetch(process.env.REACT_APP_API_URL + "/users/check-authcode", {
          method: "POST",
          headers: { "Content-Type": "application/json", },
          body: JSON.stringify({
            email,
        ...
        const response2 = await fetch(process.env.REACT_APP_API_URL + "/users/change-password", {
          method: "PUT",
          headers: { "Content-Type": "application/json", },
          body: JSON.stringify({
            email,
