import { Button, ButtonGroup, Container, CssBaseline, Typography, Box, Grid, TextField, Paper } from "@mui/material";
    ...
    <Container component="main" maxWidth="md">
      ...
      <Box sx={{ display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center", width: "100%", py: 3 }}>
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <TextField fullWidth variant="outlined" label="티켓 가격" value={ticketPrice} onChange={(e) => setTicketPrice(e.target.value)} />
          </Grid>
        </Grid>
      </Box>
